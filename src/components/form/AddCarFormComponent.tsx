...
export const AddCarFormComponent = () => {
    const{register, handleSubmit, formState: {errors, isValid}, reset} = useForm<CarFormData>(
        {
          mode: "all",
    ...
    return (
        <section className='flex flex-col items-center gap-5'>
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col items-center gap-10 border border-gray-400 rounded-lg p-10 bg-gray-700 w-100'>
                ...
                <button type={"submit"} disabled={!isValid} className='border border-gray-400 rounded-lg px-10 py-3 bg-blue-400'>Submit</button >
            </form>
